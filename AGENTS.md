...
| `internal/bankfeed/`      | Open Banking provider abstraction (Plaid, GoCardless BAD, …) | [`internal/bankfeed/AGENTS.md`](internal/bankfeed/AGENTS.md) |
...
| Users              | `GET /users`                                                                                                                                                     |
| Bank feeds         | `GET /bank-feeds/providers`, `GET /bank-feeds/institutions`, `GET/POST /bank-feeds/connections`, `GET/DELETE /bank-feeds/connections/:id`, `POST /bank-feeds/connections/:id/{finalize,reconnect,sync}`, `PUT /bank-feeds/accounts/:feedAccountId`, `POST /bank-feeds/webhooks/plaid` (public, signature-verified)                                               |
| Bank statements    | `GET /statement-lines`, `GET /statement-lines/balance`, `GET /statement-lines/:id`, `POST /statement-lines/:id/{ignore,unignore,create,match,transfer,dismiss-upstream-change}`, `GET /statement-lines/:id/matches`, `POST /statement-lines/{bulk,apply-rule,cash-code,auto-reconcile}`, `GET/POST /statement-imports`, `POST /statement-imports/:id/{remap,commit}` (manual OFX/QFX/QBO/QIF/CSV), `GET/POST /reconcile-periods`, `DELETE /reconcile-periods/:id` |
